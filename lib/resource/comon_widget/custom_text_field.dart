...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      height: widget.height ?? (widget.errorText == null ?
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          border: OutlineInputBorder(
            borderSide: widget.isBorder == false ? BorderSide.none : BorderSide(width: widget.borderWidth, color: widget.borderColor),
